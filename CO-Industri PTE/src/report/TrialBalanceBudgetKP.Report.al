    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(G_L_Account___Net_Change_; +"G/L Account"."Net Change (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Net_Change__Control28; -"G/L Account"."Net Change (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(G_L_Account___Budgeted_Amount_; +"G/L Account"."Budgeted Amount (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Balance_at_Date_; +"G/L Account"."Balance at Date (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Balance_at_Date__Control32; -"G/L Account"."Balance at Date (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(GLAcc2__Budget_at_Date_; +GLAcc2."Budget at Date (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(G_L_Account___Net_Change__Control37; +"G/L Account"."Net Change (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Net_Change__Control38; -"G/L Account"."Net Change (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(G_L_Account___Budgeted_Amount__Control40; +"G/L Account"."Budgeted Amount (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Balance_at_Date__Control41; +"G/L Account"."Balance at Date (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(GLAcc2__Budget_at_Date__Control44; +GLAcc2."Budget at Date (ex ultimo)")
                {
                    DecimalPlaces = 0 : 0;
                }
            }
            ...
            begin
                CalcFields("Net Change (ex ultimo)", "Budgeted Amount (ex ultimo)", "Balance at Date (ex ultimo)");
                GLAcc2 := "G/L Account";
                GLAcc2.CalcFields("Budget at Date (ex ultimo)");
                if "Budgeted Amount (ex ultimo)" = 0 then
                    DiffPct := 0
                else
                    DiffPct := "Net Change (ex ultimo)" / "Budgeted Amount (ex ultimo)" * 100;
                if GLAcc2."Budget at Date (ex ultimo)" = 0 then
                    DiffAtDatePct := 0
                else
                    DiffAtDatePct := "Balance at Date (ex ultimo)" / GLAcc2."Budget at Date (ex ultimo)" * 100;
